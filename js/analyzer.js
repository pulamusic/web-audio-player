...
let audioUrl = "../assets/audio/Xade-Woodwind-Quintet.mp3";
// Global variables for the Graphics
const canvasWidth  = 512;
const canvasHeight = 256;
let ctx;

ctx = document.querySelector('#audio-canvas').getContext('2d');
...
function loadSound(url) {
    document.getElementById('analyzer-msg').textContent = "Loading audio...";
    ...
    request.onload = function () {
        audioContext.decodeAudioData(request.response, function (buffer) {
            document.getElementById('analyzer-msg').textContent = "Audio sample download finished";
            audioData = buffer;
            playSound(audioData);
        }, onError);
    }
